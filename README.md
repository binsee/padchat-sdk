...
- [Padchat-sdk](#padchat-sdk)
  ...
  - [4. 通讯接口](#4-通讯接口)
    ...
    - [4.2. 通信协议](#42-通信协议)
      - [4.2.1. 连接授权](#421-连接授权)
      - [4.2.2. API请求操作结果（识别异步请求）](#422-api请求操作结果（识别异步请求）)
      - [4.2.3. 数据规则约定](#423-数据规则约定)
    - [4.3. API请求结构](#43-api请求结构)
      - [4.3.1. data字段总述](#431-data字段总述)
